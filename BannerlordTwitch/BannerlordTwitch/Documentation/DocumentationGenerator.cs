...
namespace BannerlordTwitch
{
    public class DocumentationGenerator : IDocumentationGenerator
    {
            ...
            string language, bool hidden)
        {
            ...
            yield return $"<div class=\"guide-filters\" role=\"group\" aria-label=\"{Text("Guide sections", "Разделы гайда")}\"><button class=\"is-active\" type=\"button\" data-guide-filter=\"all\">{Text("All", "Все")}</button><button type=\"button\" data-guide-filter=\"commands\">{Text("Commands", "Команды")}</button><button type=\"button\" data-guide-filter=\"rewards\">{Text("Rewards", "Награды")}</button><button type=\"button\" data-guide-filter=\"classes\">{Text("Classes", "Классы")}</button><button type=\"button\" data-guide-filter=\"roles\">{Text("Game Roles", "Игровые роли")}</button><button type=\"button\" data-guide-filter=\"settings\">{Text("Settings", "Настройки")}</button><button type=\"button\" data-guide-filter=\"streaks\">{Text("Kill streaks", "Серии убийств")}</button><button type=\"button\" data-guide-filter=\"achievements\">{Text("Achievements", "Достижения")}</button><button type=\"button\" data-guide-filter=\"map\">{Text("Map", "Карта")}</button></div>";
